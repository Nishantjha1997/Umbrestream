...
- Next command: add deterministic native UI tests and implement the consent-based WebView fallback for iframe candidates; keep release/device/provider testing gated until that path is complete.
