...
- [x] SF-A3-001b — Add Media3 offline download service and persistent playback cache
  ...
  - Commit: `46dcddb`
  - Completed: 2026-08-21
  - Next action: configure an explicit provider-authorized allowlist only when a source contract permits permanent storage; no current third-party provider is enabled by default
...
## P0 — Anime startup, source recovery, and mobile player chrome

- [x] SF-P0-007 — Repair anime first-load autoplay/source ordering and mobile player chrome
  - Status: completed
  - Priority: P0
...
- [x] SF-P0-008 — Expand Anivexa direct provider fan-out
  - Status: completed
  - Priority: P0
  - Depends on: SF-P0-007
  - Evidence: focused Anime integration (including all-provider direct fallback), source registry, startup, lint, TypeScript, and diff checks pass; production source route returned HTTP 200 after deployment with three observed Anivexa Sub providers and three observed Anivexa Dub providers, no Anime Cinezo entries, and same-audio native candidates
  - Commit: `96616c1`, `b30d352`, `62b0ae3`
  - Completed: 2026-08-21
