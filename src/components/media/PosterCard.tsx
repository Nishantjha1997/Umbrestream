 ...
 * decision).** This file used to paint a permanent 60%-tall gradient scrim
 * over the bottom of every card, with title/year/rating sitting on top of
 * it — an earlier header comment here said a prior attempt at
 ...
 * artwork with no room below it — the billboard, continue-watching cards,
 * and the "still watching" rails, none of which use this component.
 */
