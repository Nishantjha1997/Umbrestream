 ...
 * directly — rotating to landscape *is* fullscreen. No auto-hide-chrome
 * either — `PlayerShellHeaderContext` has no `hidden` value to consume, and
 * `DESKTOP_SPEC.md` §I is explicit that player controls stay visible, no
 * idle timer.
 */
  ...
  return (
    <div className="player-safe-header pointer-events-none absolute top-0 z-40 flex h-24 w-full items-start justify-between gap-2 bg-linear-to-b from-black/80 to-transparent text-white sm:h-28">
      ...
      <div className="flex items-center gap-1 sm:gap-4">
        ...
        <PlayerActionButton label="Episodes" tooltip="Episodes" onClick={onOpenEpisode} color="primary">
