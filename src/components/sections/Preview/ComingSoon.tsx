...
export default function ComingSoon({
  ...
  return (
    <div className="relative -mx-3 -my-8 flex min-h-dvh items-center justify-center overflow-hidden px-5 sm:-mx-5">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_35%,rgba(139,92,246,.26),transparent_28%),radial-gradient(circle_at_20%_80%,rgba(37,99,235,.16),transparent_25%),#0a090d]" />
